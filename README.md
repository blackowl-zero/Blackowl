...
weapons_of_choice:
  ...
  - Bash 💻
  - HTML & CSS 🎨
currently: Building tools that live in the terminal
...
<img src="https://skillicons.dev/icons?i=linux,python,bash,html,css,git,github,vscode&perline=8" alt="Tech stack"/>
...
- 🔭 Building terminal tools & automation scripts
- 🤖 Experimenting with **local LLMs** (llama.cpp, GGUF models)
- 🐧 Living in the Linux terminal — GUI is optional
...
```bash
fotis@linux:~$ echo "Thanks for stopping by! ⭐"
```
